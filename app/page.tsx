...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#05070a] font-sans text-[#e6ddc5]">
      
      {/* 1. BULLETPROOF BACKGROUND WRAPPER (Mobile + Desktop) */}
      <div className="fixed top-0 left-0 w-full h-[100dvh] md:h-screen z-0 pointer-events-none overflow-hidden">
        <Grainient
          color1="#2a313d"
          color2="#8e8e8e"
          color3="#2a313d"
      ...
      <main className="relative z-10 px-6 py-8 md:px-16 md:py-12">
