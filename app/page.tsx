        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            <section id="about" className="mb-24 pt-8 scroll-mt-20">
                ...
                <div className="flex flex-col lg:flex-row gap-10 md:gap-16 items-center lg:items-start">
                    ...
                    <div className="w-full lg:w-5/12 relative flex justify-center lg:justify-start">
                        <div className="sticky top-24 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full shadow-2xl border-4 border-[#333b47] bg-[#2a313d] flex items-center justify-center overflow-hidden ring-1 ring-[#e6ddc5]/10 group">
                            <img 
                                src="/gifs/G2.gif" 
            ...
            <section className="mb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-[#333b47] border border-[#e6ddc5]/5 p-6 rounded-md flex justify-between items-center shadow-lg">
